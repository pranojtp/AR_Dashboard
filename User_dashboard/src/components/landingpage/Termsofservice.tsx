            ...
            <div className="flex-1 flex-col pt-20 pl-30 pr-30 h-auto justify-items-center bg-black gap-15" >
                ...
                <div className="flex flex-col gap-5 text-2sm text-[#71ecbf] font-semibold leading-7">
                    ...
                    <p className="p-3">2.1. **The Service.** The Service consists of a subscription-based software platform accessible via the internet at **\[Your Website URL]** and any associated applications or documentation.
                        ...
                        2.2. **License Grant.** Subject to your compliance with these Terms and payment of the applicable fees, we grant you a **limited, non-exclusive, non-transferable, non-sublicensable license** to access and use the Service for your **internal business purposes** during the subscription term.

                        2.3. **Authorized Users.** Access to and use of the Service is restricted to the specific number of individuals or seats defined in your subscription plan ("Authorized Users"). You are responsible for all acts and omissions of your Authorized Users.

                        2.4. **Subscription and Billing.**
                        * **Fees:** You agree to pay all fees associated with your subscription plan ("Fees") as outlined on our pricing page or order form.
                        * **Auto-Renewal:** Your subscription will automatically renew at the end of each billing cycle (e.g., monthly or annually) unless you cancel your subscription at least **\[Number]** days prior to the renewal date.
                    ...
                    <p className="p-3">3.1. **Ownership of Customer Data.** As between us and you, you retain all right, title, and interest in and to all data, information, or content uploaded by you or your Authorized Users to the Service ("Customer Data").
                        ...
                        3.2. **License to Company.** You grant us a worldwide, non-exclusive, royalty-free license to use, copy, transmit, and display the Customer Data **only as necessary to provide, maintain, and support the Service** for you.

                        3.3. **Security and Protection.** We will maintain administrative, physical, and technical safeguards for the protection of the security, confidentiality, and integrity of Customer Data.
                    ...
                    <p className="p-3">4.1. **Prohibited Activities.** You and your Authorized Users agree not to:
                        ...
                        * Use the Service to store, transmit, or process any infringing, libelous, unlawful, or otherwise tortious material, or to store or transmit material in violation of third-party privacy rights.
                    ...
                    <p className="p-3">6.1. **Termination by Customer.** You may terminate your subscription at any time via your account settings. Termination will take effect at the end of your current paid subscription period, and you will not receive a refund for any pre-paid Fees.
                        ...
                        6.2. **Termination by Company.** We may terminate or suspend your account and access to the Service immediately if:
                        * You fail to pay any Fees when due.
                        * You breach any material provision of these Terms (especially Section 4).
                        * Required by law or a governmental authority.

                        6.3. **Effect of Termination.** Upon termination:
                        * Your license to use the Service shall immediately cease.
                    ...
                    <p className="p-3">8.1. **Governing Law and Venue.** These Terms shall be governed by and construed in accordance with the laws of the **State of \[Your State/Country]**, without regard to its conflict of law principles. Any legal action or proceeding arising under these Terms will be brought exclusively in the courts located in **\[Your City/County, State/Country]**.
                        ...
                        8.2. **Entire Agreement.** These Terms, together with any applicable order form or price schedule, constitute the entire agreement between you and us concerning your use of the Service.

                        8.3. **Modifications.** We may revise these Terms from time to time. The most current version will always be posted on our website. If a revision is material, we will notify you via email or a notification within the Service. Your continued use of the Service after the effective date of the changes constitutes acceptance of the new Terms.

                        8.4. **Contact Information.** If you have any questions about these Terms, please contact us at:
