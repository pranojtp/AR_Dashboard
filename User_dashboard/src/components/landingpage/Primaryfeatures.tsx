...
const features = [
    ...
    },
    {
        ...
        description: 'Streamlined workflows for enahnced productivity.',
        icon: Folder,
    },
    {
        name: 'Compliances.',
        ...
        <>
            ...
            >
                <div className="py-24 sm:py-32">
                    ...
                    <div className="mx-auto mt-16 max-w-7xl px-6 pt-8 sm:mt-20 md:mt-24 lg:px-8">
                            ...
                            {features.map((feature) => (
                                <div key={feature.name} className="relative pl-9">
                                    <dt className="inline font-semibold text-white">
                                        <feature.icon aria-hidden="true" className="absolute left-1 top-1 size-5 text-lime-500" />
                                        {feature.name}
                                    </dt>{' '}
