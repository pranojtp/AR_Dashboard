...
const Editteammember = ({ member, onClose, onSave }: EditTeamMemberProps) => {
    ...
    return (
        <div className="bg-neutral-950 p-6 rounded-2xl w-full max-w-md border border-neutral-700">
            ...
            <div className="space-y-2 max-h-60 overflow-y-auto scrollbar-thin scrollbar-thumb-neutral-600 scrollbar-track-transparent pr-1">
                {/* {member.map((mem) => ( */}
                <div
                    className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 bg-neutral-800 border border-neutral-600 rounded-md px-2 py-1 mb-4"
                >
                    ...
                    <div className="flex items-center text-xs">
                        <select
                            ...
                            className="p-2 focus:outline-none border-1 border-neutral-700 rounded bg-neutral-800 text-white"
                        >
